...
class RS_FSV(instrument): 
    ...
    def __init__(self,addr = 'TCPIP::192.168.1.102::INSTR',reset=False,verb=True, **kw):
    ...
    def set_trigger_thres(self,value):

        if (value < 0.5 or value > 3.5):
            print ('Error: Out of limit...')
            

        self.write('TRIG:LEV {}V'.format(value))                         
