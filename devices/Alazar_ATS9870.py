...
class Alazar_ATS9870(Instrument):
    ...
    def __init__(self, name, mem_size=2048, ATS_buffer=[],
        ...
        self.add_parameter(
            ...
            units='Volt (Vp)',
            type=types.FloatType, channels=(1, 2), channel_prefix='ch%d_')
        ...
        self.add_parameter(
            ...
            type=types.IntType, units='Volt')
        self.add_parameter(
            'ro_timeout', flags=Instrument.FLAG_GETSET,
            type=types.IntType, units='ms')
...
#####################
    ...
    def get_rescaled_data(self, silent=True):
        '''
        get data from ats rescaled to voltage
        '''
        dat = self.get_data(silent=silent)
