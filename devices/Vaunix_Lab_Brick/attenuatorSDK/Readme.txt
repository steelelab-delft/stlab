...
LDA-203, LDA-602EH, LDA-602Q, LDA-906V, and LDA-133 attenuators.
...
software that uses the LDA-602Q quad attenuator. After calling the function the channel will be set to the new channel value.
